...
if (isset($_POST['submit'])) {
    ...
    if ((mysqli_num_rows($result)) != 1) {
        echo "<center><h3><script>alert('Desculpe... Email ou senha errados!');</script></h3></center>";
        ...
        <div class="container">
            <div class="box-wrapper">
                <div class="box box-border">
                    <div class="box-body">
                        <center>
                            <h4 style="font-family: Noto Sans;">Login</h4>
                        </center><br>
                        <form method="post" action="Login.php" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label class="fw">Senha:
                                </label>
                                <input type="password" name="password" class="form-control">
                                <label class="ffw">
                                    <a href="PasswordRecovery.php" class="pull-right">Esqueceu a senha?</a>
                                </label>
                            </div>
                            ...
                            <div class="form-group text-center">
                                <span class="text-muted">Não possui uma conta?</span> <a href="Register.php">Registrar</a>
                            </div>
                        </form>
                    </div>
                </div>
