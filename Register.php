...
if (isset($_POST['submit'])) {
    ...
    if ((mysqli_num_rows($result)) > 0) {
        echo "<center><h3><script>alert('Desculpe.. O email já está registrado!!');</script></h3></center>";
        header("refresh:0;url=Login.php");
    } else {
        $str = "INSERT INTO user SET name='$name',email='$email',password='$password',institution='$institution'";
        if ((mysqli_query($con, $str)));
        echo "<center><h3><script>alert('Parabéns, você está cadastrado no Quiz Online !!');</script></h3></center>";
        header("refresh:0;url=Login.php");
    }
}
?>
...
<head>
    ...
    <title>REGISTRAR Quiz Online</title>
        ...
        <div class="container">
            <div class="box-wrapper">
                <div class="box box-border">
                    <div class="box-body">
                        <center>
                            <h4 style="font-family: Noto Sans;">Registrar</h4>
                        </center><br>
                        <form method="post" action="Register.php" enctype="multipart/form-data">
                            ...
                            <div class="form-group text-center">
                                <span class="text-muted">Já possui uma conta?! </span> <a href="Login.php">Login </a>
                            </div>
                        </form>
                    </div>
                </div>
